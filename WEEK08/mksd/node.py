...
def dijkstra(start,destination):     # 다익스트라 start : 출발지 , destination : 도착지
...
k = 1       # 지하철 연결 업데이트 if문으로 줄이기 용 (서해선, 경강선, 우이신설선 미구현)
if k == 1:
...
# print(dijkstra("대림","시청"))      # 9
# print(dijkstra("새절(신사)","구산")) # 6호선 순환 양방향으로 설계해서 작게 나옴. (2)
# print(dijkstra("검암","운서"))      # 3 (공항철도)
# print(dijkstra("효창공원앞","공덕")) # 1
# print(dijkstra("구로","샛강"))      # 5
# print(dijkstra("구로","영등포구청")) # 3
# print(dijkstra("구로","이촌"))      # 7
print(dijkstra("구로","대흥"))      # 8

# 여러 역 실행하면 결과 값 이상해짐. + 6호선 순환 미구현 + 경로 미구현